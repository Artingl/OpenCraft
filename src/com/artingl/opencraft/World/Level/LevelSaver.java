...
public class LevelSaver {
    ...
    public void create() {
        try {
            new File(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName).mkdir();
            this.dos = new DataOutputStream(
                    new GZIPOutputStream(
                            new FileOutputStream(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "level.data")));
            new File(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "world_region").mkdir();
            new File(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "hell_region").mkdir();
    ...
    public void load() {
        try {
            ...
            this.dis = new DataInputStream(
                    new GZIPInputStream(
                            new FileInputStream(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "level.data")));
            new File(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "world_region").mkdir();
            new File(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "hell_region").mkdir();

            File folder = new File(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "world_region");
            ...
            for (File listOfFile : listOfFiles) {
                ...
                if (listOfFile.isFile() && name.endsWith(".dat")) {
                    DataInputStream local_dis = new DataInputStream(
                            new GZIPInputStream(
                                    new FileInputStream(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + "world_region" + File.separator + name)));
        ...
        for (Regions reg: updatedRegions) {
            ...
            try {
                ...
                DataOutputStream local_dos = new DataOutputStream(
                        new GZIPOutputStream(
                                new FileOutputStream(OpenCraft.getGameDirectory() + "saves" + File.separator + levelName + File.separator + dir + File.separator + position.x + "x" + position.y + ".dat")));
