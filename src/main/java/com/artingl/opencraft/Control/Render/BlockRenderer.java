...
public class BlockRenderer
{
    ...
    public static void renderBlockIcon(BufferRenderer t, float scale_x, float scale_y, float x, float y, Block block)
    {
        renderBlockIcon(t, 0, 0, scale_x, scale_y, x, y, block);
    }

    public static void renderBlockIcon(BufferRenderer t, float rot, float rot2, float scale_x, float scale_y, float x, float y, Block block)
    {
        GL11.glPushMatrix();
    ...
    public static void render(BufferRenderer t, float x, float y, float z, Block block)
    {
        if (block.isTile()) {
            ...
            if (haveToRenderSide(Direction.Values.UP, x, y, z, block))
            {
                renderTopSide(t, x, y, z, block);
            }
            if (haveToRenderSide(Direction.Values.DOWN, x, y, z, block))
            {
                renderBottomSide(t, x, y, z, block);
            }
            if (haveToRenderSide(Direction.Values.NORTH, x, y, z, block))
            {
                renderBackSide(t, x, y, z, block);
            }
            if (haveToRenderSide(Direction.Values.EAST, x, y, z, block))
            {
                renderRightSide(t, x, y, z, block);
            }
            if (haveToRenderSide(Direction.Values.SOUTH, x, y, z, block))
            {
                renderFrontSide(t, x, y, z, block);
            }
            if (haveToRenderSide(Direction.Values.WEST, x, y, z, block))
            {
    ...
    public static boolean haveToRenderSide(Direction.Values side, float x, float y, float z, Block block)
    {
        Block block0 = BlockRegistry.Blocks.air;

        if (side == Direction.Values.UP) block0 = Opencraft.getLevel().getBlock((int)x, (int)y + 1, (int)z);
        if (side == Direction.Values.DOWN) block0 = Opencraft.getLevel().getBlock((int)x, (int)y - 1, (int)z);
        if (side == Direction.Values.NORTH) block0 = Opencraft.getLevel().getBlock((int)x, (int)y, (int)z - 1);
        if (side == Direction.Values.EAST) block0 = Opencraft.getLevel().getBlock((int)x + 1, (int)y, (int)z);
        if (side == Direction.Values.SOUTH) block0 = Opencraft.getLevel().getBlock((int)x, (int)y, (int)z + 1);
        if (side == Direction.Values.WEST) block0 = Opencraft.getLevel().getBlock((int)x - 1, (int)y, (int)z);

        if (block.isLiquid())
        {
            return !block0.isVisible() && !block0.isLiquid();
        }

        return !block0.isVisible() || block0.hasTranslucent() || block0.isLiquid() || block0.isTile();
    }

    public static void renderTopSide(BufferRenderer t, float x, float y, float z, Block block)
    {
        renderTopSide(t, x, y, z, 1, block);
    }

    public static void renderBottomSide(BufferRenderer t, float x, float y, float z, Block block)
    {
        renderBottomSide(t, x, y, z, 1, block);
    }

    public static void renderBackSide(BufferRenderer t, float x, float y, float z, Block block)
    {
        renderBackSide(t, x, y, z, 1, block);
    }

    public static void renderRightSide(BufferRenderer t, float x, float y, float z, Block block)
    {
        renderRightSide(t, x, y, z, 1, block);
    }

    public static void renderFrontSide(BufferRenderer t, float x, float y, float z, Block block)
    {
        renderFrontSide(t, x, y, z, 1, block);
    }

    public static void renderLeftSide(BufferRenderer t, float x, float y, float z, Block block)
    {
        renderLeftSide(t, x, y, z, 1, block);
    }
    
    public static void renderTopSide(BufferRenderer t, float x, float y, float z, float blockSize, Block block)
    {
        int block_r=255;
        int block_g=255;
        int block_b=255;
    ...
    public static void renderBottomSide(BufferRenderer t, float x, float y, float z, float blockSize, Block block)
    {
        int block_r=222;
        int block_g=222;
        int block_b=222;
    ...
    public static void renderBackSide(BufferRenderer t, float x, float y, float z, float blockSize, Block block)
    {
        int block_r=215;
        int block_g=215;
        int block_b=215;
    ...
    public static void renderRightSide(BufferRenderer t, float x, float y, float z, float blockSize, Block block)
    {
        int block_r=230;
        int block_g=230;
        int block_b=230;
    ...
    public static void renderFrontSide(BufferRenderer t, float x, float y, float z, float blockSize, Block block)
    {
        int block_r=230;
        int block_g=230;
        int block_b=230;
    ...
    public static void renderLeftSide(BufferRenderer t, float x, float y, float z, float blockSize, Block block)
    {
        int block_r=215;
        int block_g=215;
        int block_b=215;
    ...
    public static void renderTile0(BufferRenderer t, float x, float y, float z, Block block) {
        renderTile0(t, x, y, z, 0, block);
    }


    public static void renderTile1(BufferRenderer t, float x, float y, float z, Block block) {
        renderTile1(t, x, y, z, 0, block);

    }

    public static void renderTile1(BufferRenderer t, float x, float y, float z, float tileSize, Block block) {
        int block_r=255;
        int block_g=255;
        int block_b=255;
    ...
    public static void renderTile0(BufferRenderer t, float x, float y, float z, float tileSize, Block block) {
        int block_r=255;
        int block_g=255;
        int block_b=255;
    ...
    public static void renderBlockOutline(EntityPlayer player, BufferRenderer t, int x, int y, int z, int face) {
